...
export default class LoadingScreen {
	...
	static updateQuote() {
		...
		let el = $("#funny_loading_quote");

		el.animate({'opacity': 0}, 500, function () {
			$(this).text(LoadingScreen.getQuote());
